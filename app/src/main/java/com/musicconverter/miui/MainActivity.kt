    ...
    private fun appendLocalMusicPage() {
        ...
        for (index in from until to) {
            ...
            if (!track.artwork.isNullOrBlank()) {
                ImageLoader.load(track.artwork, artworkView)
            } else {
                OnlineCoverResolver.resolve(this, track.title, track.artist) { coverUrl ->
...
private fun buildEditorHubPage(): ScrollView {
    ...
    private fun buildAboutPage(): ScrollView {
        ...
        infoCard.addView(UiKit.groupDivider(this))
        infoCard.addView(UiKit.groupRow(this, "⌘", "开源组件", "FFmpeg / FFmpegKit · Chaquopy · Room · music-geshizhuanhuan"))
